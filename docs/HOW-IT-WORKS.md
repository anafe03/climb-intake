...
| Urgency exact / within tolerance | 77% / 97% | 77% / 100% |
| Sender-confidence calibration | 100% | 100% |
| Overclaimed confidence | none | none |
| p50 latency per ticket | under 5 ms | 17.6 s |

30 gold tickets: the 10 provided, plus 20 edge cases written to trap the failure modes — false
